...
const QMetaObjectExtraData Message::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Message::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Message,
      qt_meta_data_Message, &staticMetaObjectExtraData }
};
